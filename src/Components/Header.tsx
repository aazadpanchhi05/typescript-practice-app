...
export const Header = () => {
  ...
  const classes = {
    ...
    button:
      'inline-block text-sm mr-10 px-4 py-2 leading-none border rounded text-yellow-200 border-yellow-200 hover:border-transparent hover:text-black hover:bg-white mt-4 lg:mt-0',
  }

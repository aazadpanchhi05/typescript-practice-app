...
export const SignupForm = () => {
    ...
    const classes = {
        ...
        nameInputField: "w-full px-3 py-2 text-sm text-gray-700 border rounded shadow appearance-none focus-outline focus:border-transparent",
                ...
                <form className='bg-white rounded'>
                    ...
                    <div className="mb-4 md:flex md:justify-between">
                        <div className="mb-4 md:mr-2 md:mb-0">
                            <label className={classes.nameLable}>
                                First Name
                            </label>
                            <input
